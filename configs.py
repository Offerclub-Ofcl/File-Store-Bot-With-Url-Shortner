...
class Config(object):
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "6427137619:AAHThCu89pDAt9q9VRMwx0wyn71ZC3wIyJM")
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "FuTech_Rename_Bot")
  ...
  DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://tharunthedon001:tharunthedon001@cluster0.zody7ze.mongodb.net/?retryWrites=true&w=majority")
